...
public class SearchButtonConfig {
    ...
    public SearchButtonConfig(FileConfiguration config) {
        this.material = Material.valueOf(config.getString(ConfigEnum.GUI_ACTIVE_BOUNTIES_SEARCH_BUTTON_MATERIAL.getPath()));
        this.name = config.getString(ConfigEnum.GUI_ACTIVE_BOUNTIES_SEARCH_BUTTON_NAME.getPath());
        this.lore = config.getStringList(ConfigEnum.GUI_ACTIVE_BOUNTIES_SEARCH_BUTTON_LORE.getPath()).toArray(new String[0]);
    }
